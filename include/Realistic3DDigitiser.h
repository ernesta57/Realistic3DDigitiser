...
#define Realistic3DDigitiser_h 1
 ...
 * <br>
 */
class Realistic3DDigitiser : public k4FWCore::MultiTransformer<std::tuple<edm4hep::SimTrackerHitCollection,
...
public:  
    ...
    Realistic3DDigitiser(const std::string& name, ISvcLocator* svcLoc);
...
protected:
    ...
    // NOTE: Lorentz-angle deflection is not applied
    Gaudi::Property<double> m_tanLorentzAngleX{this, "TanLorentz", (double)0.8, "Tangent of Lorentz Angle (unused by 3D transport model)"};
    Gaudi::Property<double> m_tanLorentzAngleY{this, "TanLorentzY", (double)0, "Tangent of Lorentz Angle along Y (unused by 3D transport model)"};
    ...
    // 3D-sensor column geometry. One readout column per pixel, 
    // unless explicitly overridden (see ColumnGrid.h).
